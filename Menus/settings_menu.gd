...
func _ready():
	...
	# todo - if you want the option to save your game from this menu, replace the hardcoded
	# false with logic that assures the game is in a savable state
	save_button.visible = false
	
	# todo - change this to true or replace with logic that assure the player is safe to 
